...
power_multiplier_ranges, power_multiplier_frequencies = bin_data_custom_ranges(power_multipliers, np.linspace(np.min(power_multipliers), np.max(power_multipliers), 11))
